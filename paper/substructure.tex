...
The posterior free-streaming time $\taufs=0.37_{-0.27}^{+0.34}\ \fmc$ obtained in this work is significantly smaller than our previous estimate $\taufs=1.16_{-0.25}^{+0.29}\ \fmc$ in Ref.~\cite{Bernhard:2018hnz}.
...
\begin{enumerate}[itemsep=0pt, leftmargin=2\parindent]
  ...
  \item
    Our posterior estimate for the pre-equilibrium free-streaming time is $\taufs=0.37_{-0.27}^{+0.34}\ \fmc$.
