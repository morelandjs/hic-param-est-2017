...
We then perform Markov-chain Monte Carlo (MCMC) importance sampling on the posterior distribution $P(\xv | E)$ in Eq.~\eqref{eq:bayes} to draw random samples of the true model parameters $\xv_\star$, given the predictions of the model and the evidence provided by the experimental data \cite{Goodman:2010en, FM:2013mc}.
