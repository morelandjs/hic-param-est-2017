...
%Unlike heavy-ion collisions, small system collisions , were not expected
%
%Generally speaking, hydrodynamic flow signals were not expected to be observed
%
%
%Recent measurements measurements of multiparticle correlations in $p$-Pb collisions are surprisingly similar to those measured in Pb-Pb collisions.
%
%The hydrodynamic framework, however, is naturally expected to break down in the dilute limit where discrete particle degrees of freedom dominate and continuous field descriptions of the medium cease to make sense.
%It thus came somewhat as a surprise when high-multiplicity $p$-Pb collisions were found to produce long-range multiparticle correlations similar in magnitude to those observed in Pb-Pb collisions.
%The observation challenged preconceived notions of hydrodynamic applicability and suggested that even proton-lead collisions produce small droplets of QGP liquid which evolve hydrodynamically.
%
%The potential for a unified hydrodynamic description of small and large collision systems is of course very appealing, although it is by no means given.
%Multiple alternative explanations for the observed correlations have been proposed in the literature, and these mechanisms may contribute to the observed correlations in part or in full.
%
%Relativistic Au-Au and Pb-Pb collisions at RHIC and the LHC produce long-range multiparticle correlations which are commonly explained by the existence of hydrodynamic flow \note.
%Perhaps the strongest evidence for this claim has been the overwhelming success of hydrodynamic models in describing (and even predicting) a large number of soft-sector observables in relativistic heavy-ion collisions \note.
%
%The hydrodynamic framework, however, is naturally expected to break down in the dilute limit where discrete particle degrees of freedom dominate and continuous field descriptions of the medium cease to make sense.
%It thus came somewhat as a surprise when high-multiplicity $p$-Pb collisions were found to produce long-range multiparticle correlations similar in magnitude to those observed in Pb-Pb collisions.
%The observation challenged preconceived notions of hydrodynamic applicability and suggested that even proton-lead collisions produce small droplets of QGP liquid which evolve hydrodynamically.
