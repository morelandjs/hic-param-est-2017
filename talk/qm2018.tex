...
\begin{frame}[plain]
  \begin{tikzpicture}
    ...
    \node<2>[below=.4cm of title, align=center] {
        \includegraphics[scale=.8]{posterior_p}\\[2ex]
    ...
    \node<3>[below=.4cm of title, align=center] {
        \includegraphics[scale=.8]{posterior_parton_number}\\[2ex]
    ...
    \node<4>[below=.4cm of title, align=center] {
        \includegraphics[scale=.8]{posterior_freestreaming}\\[2ex]
    ...
    \node<5>[below=.4cm of title, align=center] {
        \includegraphics[scale=.8]{posterior_structure}\\[2ex]
        \small Parton structure parameter $\chi_\mathrm{struct} = 0.28_{-0.16}^{+0.17}$,\\
